<template>
  <div>
    <h1>Política Privacidade</h1>
     <p>A sua privacidade é importante para nós. É política do Real para Dolar respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Real para Dolar, e outros sites que possuímos e operamos.
    ...
    <h1>Política de Cookies Real para Dolar</h1>
    ...
    <h3><li>Cookies relacionados à conta</li></h3>
    <p>
        Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. 
    ...
    <h3><li>Cookies relacionados ao login</li></h3>
    <p>
        Utilizamos cookies quando você está logado, para que possamos lembrar dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são normalmente removidos ou limpos quando você efetua logout para garantir que você possa acessar apenas a recursos e áreas restritas ao efetuar login.
    </p>
    <h3><li>Cookies relacionados a boletins por e-mail</li></h3>
    <p>
    ...
    <h3><li>Pedidos processando cookies relacionados</li></h3>
    <p>
    ...
    <h3><li>Cookies relacionados a pesquisas</li></h3>
    <p>
        Periodicamente, oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.
    </p>
    <h3><li>Cookies relacionados a formulários</li></h3>
    <p>
    ...
    <h3><li>Cookies de preferências do site</li></h3>
    <p>
    ...
    <h4>Para mais informações sobre cookies do Google Analytics, consulte a página oficial do Google Analytics.</h4>
    <p>
        <li>
    ...
    <p>
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Real para Dolar oferece no site e com caráter enunciativo, mas não limitativo:
    </p>
    <p>
        <li>
    ...
    <p>
        <li>
            B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, onde apostar ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
        </li>
    </p>
    <p>
        <li>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Real para Dolar, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
        </li>
    </p>
    ...
    <h4>Esta política é efetiva a partir de 20 setembro 2022 11:44</h4>
</div>
